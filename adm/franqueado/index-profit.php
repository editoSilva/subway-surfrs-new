    ...
    <div class="page-wrapper p-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="fs-4">
                    Cada venda que você fizer, deverá nos repassar R$6.000 + 10% GGR, qualquer valor que você cobrar
                    acima disso será o seu lucro, por exemplo: se você fizer uma venda a R$10.000 + 15% GGR, sua
                    comissão será de R$4.000 + 5% GGR pela indicação.
                </p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="w-100 text-center">
                    <a href="https://api.whatsapp.com/send?phone=21964564170&text=Quero%20ser%20um%20franqueador%20da%20ProfitIgaming ">
...
<footer class="footer text-center">
    Desenvolvido por
    <a href=<?php echo $_ENV['SITE_DESENVOLVEDORA'];?>><?php echo $_ENV['NOME_DESENVOLVEDORA'];?></a>
</footer>
<script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
