<?php
    ...
    $min_por_saque_cpa = $result['min_por_saque_cpa'];
  ...
  <div class="card">
    <div class="card-body">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <form action='update.php?field=min_por_saque_cpa' method='post'>
                    <p class="title">Minimo por saque:</p> 
                    <p class="description">Valor minimo que um afiliado irá conseguir sacar por dia.</p>
                    <input class="box-input" name="value" value="<?php echo $min_por_saque_cpa ?>"/>
                    <button type="submit" class="btn box-btn btn-primary">Salvar Alterações</button>
                </form>
            </div>
            <div class="box">
