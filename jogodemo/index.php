...
if (!isset($_SESSION['email'])) {
    header("Location: ${_ENV['BASE_URL']}/painel");
    exit();
}
...
if(get_by('appconfig', ['email' => $email])['jogo_demo'] == 0){
    header("Location: ${_ENV['BASE_URL']}/painel");
    exit();
}

stmt("UPDATE appconfig set jogo_demo = jogo_demo - 1 where email='$email'");
...
<body>
    ...
    <script>
        /*function redirecionarParaOutraPagina() {
            ...
            window.location.href = '../deposito/?msg=gameover';
        }*/
    </script>
